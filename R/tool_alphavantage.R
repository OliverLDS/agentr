...
#'
#' @export
fetch_ts_daily_alphavantage <- function(symbol, mode = c('compact', 'full'), config = tool_set_config('alphavantage')) {
...
# agent$set_config('alphavantage')
# agent$fetch_ts_daily_alphavantage('SPY', mode = 'full')
