test_that("design_review_html returns standalone review page", {
  ...
  expect_true(grepl("knowledge_graph_canvas", html, fixed = TRUE))
  expect_true(grepl("memory_schema_graph_canvas", html, fixed = TRUE))
  expect_true(grepl("Narrative knowledge map", html, fixed = TRUE))
  expect_true(grepl("Memory schema graph", html, fixed = TRUE))
